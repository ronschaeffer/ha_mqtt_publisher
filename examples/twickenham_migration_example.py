...
def build_twickenham_entities(
    config: Config, device: Device, base_prefix: str = "twickenham_events"
):
    ...
    entities.extend(
        create_command_entities(config, device, base_prefix, command_topics)
    )

    # Add standard buttons
    entities.extend(
        create_standard_buttons(config, device, base_prefix, f"{base_prefix}/cmd")
    )
