...
MQTT publishing library with integrated **Home Assistant MQTT Discovery** support. This package provides both an MQTT publishing engine and a comprehensive framework for creating Home Assistant auto-discovery configurations.
